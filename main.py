...
from myTtest import myTtest
from readData import readExcelData, readCsvData

st.write(
    """
    # 🧮 T-Test App
    Upload your experiment results to see the significance of your T-test.
    """
)
...
if file_style == 'csv':
    ...
    if (uploaded_file1 and uploaded_file2) is None:
        ...
        stat, p = myTtest(uploaded_file1, uploaded_file2)

        st.subheader("Results for T-test")
